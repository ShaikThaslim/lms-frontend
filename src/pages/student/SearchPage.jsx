...
const SearchPage = () => {
  ...
  const query=searchParams.get("query");//from the search panel
const [selectedCategories,setSelectedCategories]=useState([]);//may be we can have multiple categories selected so we are using the array
